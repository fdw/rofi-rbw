...
| `--typing-start-delay`    |              | delay in milliseconds (default is `0`)                        | Set a delay before the typing starts.                                                                                                                                                                                                                                         |
| `--typing-key-delay`      |              | delay in milliseconds (default is `0`)                        | Set a delay between key presses when typing.                                                                                                                                                                                                                                  |
